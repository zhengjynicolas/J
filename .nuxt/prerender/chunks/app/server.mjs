import { version, ref, watchEffect, watch, getCurrentInstance, defineComponent, provide, shallowReactive, h, inject, Suspense, nextTick, Transition, hasInjectionContext, unref, useSSRContext, createApp, effectScope, reactive, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, computed, markRaw, isRef, isShallow, isReactive, toRaw, mergeProps } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/@unhead/shared/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/ufo/dist/index.mjs';
import { createDefu, defu, defuFn } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/defu/dist/defu.mjs';
import { klona } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/klona/dist/index.mjs';
import { extendTailwindMerge } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/tailwind-merge/dist/tailwind-merge.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/jiayuzheng/WebstormProjects/J/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-488a3355.mjs').then((m) => m.default || m)
  },
  {
    name: "doc",
    path: "/doc",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a07de5c8.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-b5ef4565.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-4b492e70.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-6b49c846.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRouter as a, useRuntimeConfig as b, createError as c, navigateTo as d, entry$1 as default, nuxtLinkDefaults as n, useHead as u };
